...
// For JS, it looks like it's ok if we pass more/less arguments than required for a function?
// createAction expects 2 arguments? JS treats the value of the missing argument (payload) as undefined.
